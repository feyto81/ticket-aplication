...
<ul class="app-menu">
  ...
  <li class="treeview  is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon {{$row->category}}"></i><span class="app-menu__label">Category</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      ...
      <li><a class="treeview-item active" href="{{url('all-category')}}"><i class="icon fa fa-circle-o"></i> All Category</a></li>
    </ul>
  </li>
...
<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <a href="{{url('import-excel-category')}}" class="btn btn-sm btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Import Excel</a>&nbsp;
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  @foreach($category as $row)
                    <tr>
                        ...
                        <td>
                            <a href="{{url('/edit-category/'.$row->id)}}" title="Edit Data" class="btn btn-primary btn-sm"><i class="fa fa-pencil fa-sm"></i></a>
                  		    <a href="#" class="btn btn-danger btn-sm btn-delete"  title="Hapus Data" category-id="{{$row->id}}"><i class="fas fa-sm fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                  </tbody>
