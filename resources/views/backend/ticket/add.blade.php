...
@section('title','Add Ticket | Ticket')
@section('menu')
<ul class="app-menu">
  ...
  <li class="treeview is-expanded"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon {{$row->ticket}}"></i><span class="app-menu__label">Ticket</span><i class="treeview-indicator fa fa-angle-right"></i></a>
    <ul class="treeview-menu">
      <li><a class="treeview-item active" href="{{url('add-ticket')}}"><i class="icon fa fa-circle-o"></i> Add Ticket</a></li>
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Add Ticket</h1>
          <p>Fill items carefully</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="{{url('/add-ticket')}}">Add Ticket</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">Add Ticket</h3>
            <div class="tile-body">
              <form action="{{url('/save-ticket')}}" method="post">
                {{ csrf_field() }}
                <div class="form-group{{$errors->has('ticket_name') ? 'has-error' : '' }}">
                  <label class="control-label">Ticket Name</label>
                  <input class="form-control" name="ticket_name" id="ticket_name" type="text" placeholder="Enter Ticket Name">
                ...
                <div class="form-group{{$errors->has('ticket_type') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control" name="ticket_type" id="ticket_type" type="text" placeholder="Enter Ticket Type">
                ...
                <div class="form-group{{$errors->has('number_of_tickets') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control" name="number_of_tickets" id="number_of_tickets" type="number" placeholder="Enter Amount">
                ...
                <div class="form-group{{$errors->has('ticket_price') ? 'has-error' : '' }}">
                    ...
                    <input class="form-control uang" name="ticket_price" id="ticket_price" type="number" placeholder="Enter Ticket Price">
