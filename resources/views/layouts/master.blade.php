...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    <?php
        $all_published_setting = DB::table('settings')
                                    ->get();
        foreach ($all_published_setting as $v_setting) {?>
           <header class="app-header" style="background-color:{{$v_setting->navbar_right}}"><a style="background-color: {{$v_setting->navbar_left}}" class="app-header__logo" href="/home">{{$v_setting->title_admin}}</a>
        <?php }?>
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          ...
          <li><a class="dropdown-item" href="{{url('/')}}/edit-setting/1"><i class="fa fa-cog"></i> Setting</a></li>
          @endif
          <li><a class="dropdown-item" href="{{url('/')}}/password"><i class="fa fa-user"></i> Change Password</a></li>
    ...
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('backend/images/48.jpg')}}" alt="User Image">
        <div>
          ...
          @if(Auth()->user()->level_id==1)
              <span class="badge badge-success">Full Stack Developer</span>
